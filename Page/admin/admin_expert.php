...
if(isset($_POST['add_expert'])){
    ...
    $select_expert_email = mysqli_query($conn, "SELECT name FROM `experts` WHERE name = '$name'") or die('query failed');
                ...
                <form action="" method="post" enctype="multipart/form-data" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="role" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary">
                        </div>
                        <div>
